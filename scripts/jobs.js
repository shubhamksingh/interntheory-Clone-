let jobs_arr=JSON.parse(localStorage.getItem("Jobs_data"))
jobs_arr.forEach(el => {
    ...
    sal.innerText=`Salary: ${salary.innerText}`;
   salary.setAttribute("class","q1")
    sal.setAttribute("class","dim1")
     div.append(img);
     div1.append(t,name,pos,city,sal)
